...
pattern = ("Heart", "Diamond", "Spade", "Clubs")
deck = ['A Heart', '2 Heart', '3 Heart', '4 Heart', '5 Heart', '6 Heart', '7 Heart', '8 Heart', '9 Heart', '10 Heart', 'J Heart', 
'Q Heart', 'K Heart', 'A Diamond', '2 Diamond', '3 Diamond', '4 Diamond', '5 Diamond', '6 Diamond', '7 Diamond', '8 Diamond', '9 Diamond', '10 Diamond', 'J Diamond', 'Q Diamond', 'K Diamond', 'A Spade', '2 Spade', '3 Spade', '4 Spade', '5 Spade', '6 Spade', '7 Spade', '8 Spade', '9 Spade', '10 Spade', 'J Spade', 'Q Spade', 'K Spade', 'A Clubs', '2 Clubs', '3 Clubs', 
'4 Clubs', '5 Clubs', '6 Clubs', '7 Clubs', '8 Clubs', '9 Clubs', '10 Clubs', 'J Clubs', 'Q Clubs', 'K Clubs']
#find that it is clubs
...
def check_total(num, total):
    if num == 11: num = 10.1 
    elif num == 12: num = 10.2
    elif num == 13: num = 10.3
    #because of float, if player get A , Q it q=10.2 10.2+11 > 21... fixing by set 21.7
    elif num == 1 and (total + 11) <= 21.7: num = 11
    return num
